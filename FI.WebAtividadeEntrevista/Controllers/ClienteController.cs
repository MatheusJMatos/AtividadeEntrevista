    ...
    public class ClienteController : Controller
    {
            ...
            else
            {
                if (bo.ValidaCPF(model.CPF))
                {
                    if (!bo.VerificarExistencia(model.CPF))
                    {
                        ...
                        return Json("Não são permitidos cadastro duplicados, por favor verifique o CPF inserido");
                }
                else
                    return Json("CPF inválido, por favor verifique o CPF inserido");
            }
        }
        ...
        {        
            ...
            else
            {
                ...
                {
                    bo.Excluir(model.Id);
                    return Json("Exclusão feita com sucesso");
                }
                catch (Exception ex)
                {
